...
${INSTRUCTION}`,
  ...
  },
  {
    id: 'codex',
    name: 'Codex',
    configPath: '~/.codex/AGENTS.md',
    note: 'Codex reads this as a global instruction in every project. Use AGENTS.md in a repository for project-only setup.',
    snippet: INSTRUCTION,
  },
  {
    id: 'other',
    name: 'Other',
    configPath: 'Your agent’s global instructions file',
    note: 'Use the place where your agent keeps instructions that apply to every project.',
    snippet: INSTRUCTION,
  },
]
